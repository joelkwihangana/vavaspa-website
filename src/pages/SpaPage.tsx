              ...
              <div className="w-full lg:w-1/2">
                ...
                >
                  <img
                    src={s.image}
                    alt={s.title}
                    className="aspect-[4/5] sm:aspect-[16/10] lg:aspect-[4/5] h-full w-full object-cover"
                  />
                </motion.div>
              </div>
          ...
          <div className="relative">
            ...
            >
              ...
              <p className="mt-8 text-lg text-muted leading-relaxed">
                Cleanliness is our foundation. From high-thread-count linens to
                the subtle scent of organic oils, every detail is engineered to
                restore your peace.
              </p>
            </motion.div>
          </div>
